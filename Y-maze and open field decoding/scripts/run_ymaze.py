...
from istbi_behavior_decoder.ymaze import run_ymaze


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Decode Y-maze videos under a base directory.")
...
def main() -> None:
    ...
    print(df.head())
    print(f"Finished. Processed {len(df)} Y-maze videos.")
